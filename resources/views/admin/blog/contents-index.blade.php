                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($content->image)
                                            <img src="{{ asset($content->image_url) }}" alt="Content Image" style="width: 50px; height: 50px;">
                                            @else
                                            No Image
                                            @endif
                                        </td>
                            ...
                            <a href="{{ route('admin.blogs.index') }}" class="btn btn-primary mt-2">Back to Blogs</a>
                        </div>
                    </div>
                </div>
            </div>
