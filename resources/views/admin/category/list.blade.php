                            ...
                            <table id="dataTable" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.categories.edit', $category->id) }}" class="btn btn-primary btn-icon-text">edit</a>
                                            <a href="{{ route('admin.categories.destroy', $category->id) }}" class="btn btn-danger btn-icon-text">delete</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
