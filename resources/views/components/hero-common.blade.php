            ...
            <div class="flex flex-col items-center justify-center xl:flex-row min-h-[20rem]">
                <div class="w-full mb-12 xl:mb-0 xl:pr-16 text-center">
                    ...
                    <div class="flex flex-col items-center md:justify-center md:flex-row mx-auto">
                        <input class="input border-none rounded-sm w-[20rem] mr-1" placeholder="Email" />
                        <input class="input border-none rounded-sm w-[20rem] mr-1 mt-2 md:mt-0" placeholder="Booking Reference Number" />
                        <button class="btn bg-white rounded-sm mt-2 md:mt-0 w-[20rem]">Get Help</button>
                    </div>
                </div>
            </div>
        </div>
