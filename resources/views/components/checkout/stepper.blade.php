<div class="flex flex-col lg:flex-row justify-between items-center p-4 border border-gray-200 bg-white">
    ...
    <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 space-x-0 sm:space-x-4 mt-4 lg:mt-0">
        <span class="text-gray-700 text-sm">Currently, you have <strong>{{ !empty($cartItems)? count($cartItems):0 }}</strong> item(s) in your cart.</span>
