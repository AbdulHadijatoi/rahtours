<div class="flex flex-col lg:flex-row justify-between items-center p-4 border border-gray-200 bg-gray-50">
    <!-- Stepper -->
    <div class="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-4 space-y-4 sm:space-y-0">
        <!-- Step 1 -->
        <div class="flex items-center space-x-2">
            <div class="w-6 h-6 flex items-center justify-center rounded-full bg-orange-500 text-white font-semibold">1</div>
        ...
        <!-- Step 2 -->
        <div class="flex items-center space-x-2">
            <div class="w-6 h-6 flex items-center justify-center rounded-full bg-gray-400 text-white font-semibold">2</div>
            <div class="flex items-center">
        ...
        <!-- Step 3 -->
        <div class="flex items-center space-x-2">
            <div class="w-6 h-6 flex items-center justify-center rounded-full bg-gray-400 text-white font-semibold">3</div>
            <div class="flex items-center">
