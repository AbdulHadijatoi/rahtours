<div class="border-b border-gray-100 py-8">
    <div class="mx-auto max-w-screen-xl text-center flex justify-center md:justify-between md:text-left flex-wrap">
        ...
        <div class="text-md flex align-center mt-3 md:mt-0">
            ...
            <a href="https://twitter.com/rahtoursdubai?s=21" rel="noreferrer" target="_blank" class="mx-3 text-teal-700 transition hover:text-teal-700/75">
                <span class="sr-only">Twitter</span>
                <svg class="size-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve"><path d="M14.095479,10.316482L22.286354,1h-1.940718l-7.115352,8.087682L7.551414,1H1l8.589488,12.231093L1,23h1.940717  l7.509372-8.542861L16.448587,23H23L14.095479,10.316482z M11.436522,13.338465l-0.871624-1.218704l-6.924311-9.68815h2.981339  l5.58978,7.82155l0.867949,1.218704l7.26506,10.166271h-2.981339L11.436522,13.338465z"/></svg>    
            </a>

            <a href="https://www.linkedin.com/company/rah-tourism-l.l.c" rel="noreferrer" target="_blank" class="mx-3 text-teal-700 transition hover:text-teal-700/75">
                <span class="sr-only">Linkedin</span>
                <svg class="size-6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 291.319 291.319" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M145.659,0c80.45,0,145.66,65.219,145.66,145.66s-65.21,145.659-145.66,145.659S0,226.1,0,145.66 S65.21,0,145.659,0z"></path> <path style="fill:#FFFFFF;" d="M82.079,200.136h27.275v-90.91H82.079V200.136z M188.338,106.077 c-13.237,0-25.081,4.834-33.483,15.504v-12.654H127.48v91.21h27.375v-49.324c0-10.424,9.55-20.593,21.512-20.593 s14.912,10.169,14.912,20.338v49.57h27.275v-51.6C218.553,112.686,201.584,106.077,188.338,106.077z M95.589,100.141 c7.538,0,13.656-6.118,13.656-13.656S103.127,72.83,95.589,72.83s-13.656,6.118-13.656,13.656S88.051,100.141,95.589,100.141z"></path> </g> </g></svg>
            </a>

            <a href="https://www.instagram.com/rahtourism/" rel="noreferrer" target="_blank" class="mx-3 text-teal-700 transition hover:text-teal-700/75">
            ...
            <a href="https://www.youtube.com/MyHabib786" rel="noreferrer" target="_blank" class="mx-3 text-teal-700 transition hover:text-teal-700/75">
                <span class="sr-only">Youtube</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="size-6"><path d="M21.593 7.203a2.506 2.506 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.515 2.515 0 0 0 1.767-1.763c.414-1.565.417-4.812.417-4.812s.02-3.265-.407-4.831zM9.996 15.005l.005-6 5.207 3.005-5.212 2.995z"></path></svg>
            </a>
...
<div class="mx-auto max-w-screen-xl px-6 pb-6 pt-16 md:px-0 lg:pt-10">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div class="text-center sm:text-left">
                ...
                <ul class="mt-5 space-y-4 text-sm">
                    <li>
                        <a href="https://www.google.com/maps/search/?api=1&query=Suite+714,+Makateb+Tower+-+Dubai" target="_blank" class="flex items-center justify-center gap-1.5 ltr:sm:justify-start">
                            <svg
                    ...
                    <li>
                        <a href="tel:+971529331100" class="flex items-center justify-center gap-1.5 ltr:sm:justify-start">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="size-5 shrink-0 text-gray-900"
                            fill="none"
                            ...
                            <span class="flex-1 text-gray-700 hover-text-secondary">+971 52 933 1100</span>
                        </a>
                    </li>

                    <li>
                        <a href="mailto:info@rahtours.ae" class="flex items-center justify-center gap-1.5 ltr:sm:justify-start">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="size-5 shrink-0 text-gray-900"
                            fill="none"
            ...
            <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900">What We Do</p>

                <ul class="mt-5 space-y-4 text-sm">
                    <li>
                        <a href="{{ url('about-us') }}" class="text-gray-700 transition hover-text-secondary">
                            About Us
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('where-to-find-us') }}" class="text-gray-700 transition hover-text-secondary">
                            Where to find us
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('dubai-activities') }}" class="text-gray-700 transition hover-text-secondary">
                            Dubai Activities
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('blogs') }}" class="text-gray-700 transition hover-text-secondary">
                            Blogs
                        </a>
                    </li>
            ...
            <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900">Terms Of Use</p>
                <ul class="mt-5 space-y-4 text-sm">
                    <li>
                        <a class="text-gray-700 transition hover-text-secondary" href="{{ url('terms-and-conditions') }}">
                            Terms & Conditions 
                        </a>
                    </li>
                    <li>
                        <a class="text-gray-700 transition hover-text-secondary" href="{{ url('privacy-policy') }}">
                            Privacy Policy 
                        </a>
                    </li>
                    <li>
                        <a class="text-gray-700 transition hover-text-secondary" href="{{ url('guidelines') }}">
                            Guidelines 
                        </a>
                    </li>
            ...
            <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900">Newsletter</p>
...
<div class="mt-12 border-t border-gray-200 pt-6 pb-6">
    <div class="mx-auto max-w-screen-xl text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
            Copyright &copy; RAH Tours L.L.C {{ date('Y') }} All rights reserved.
        </p>
