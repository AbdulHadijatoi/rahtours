  ...
  <div class="card-body h-[8rem] flex flex-column justify-between">
    ...
    <div class="flex">
        ...
        @if($activity->packages[0]->category == "private")
            ...
            <span class="text-sm font-extrabold mr-1 text-gray-500 text-secondary">From AED {{ $activity->packages[0]->price }}</span>
        ...
        @else
            ...
            <span class="text-sm font-extrabold mr-1 text-gray-500 text-secondary">From AED {{ $activity->packages[0]->adult_price }}</span>
