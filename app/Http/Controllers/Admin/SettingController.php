...
class SettingController extends Controller
{
    ...
    public function contactUsIndex()
    {
        ...
        return view('admin.setting.contact.index',compact('data'));
    }
    ...
    {
        return view('admin.setting.find.create');
    }
    ...
    public function findUsIndex()
    {
        ...
        return view('admin.setting.find.index',compact('data'));
    }

    public function findUsEdit($id)
    {
        $data=SettingFindUs::findOrFail($id);
        return view('admin.setting.find.edit',compact('data'));
    }
