...
class GuidelinesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setting.guidelines.index',compact('data'));
    }
    ...
    {
        return view('admin.setting.guidelines.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.setting.guidelines.edit',compact('data'));
    }
