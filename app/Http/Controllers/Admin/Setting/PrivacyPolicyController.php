...
class PrivacyPolicyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setting.privacypolicy.index',compact('data'));
    }
    ...
    {
        return view('admin.setting.privacypolicy.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.setting.privacypolicy.edit',compact('data'));
    }
