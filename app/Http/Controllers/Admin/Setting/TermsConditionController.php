...
class TermsConditionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setting.termsconditions.index',compact('data'));
    }
    ...
    {
        return view('admin.setting.termsconditions.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.setting.termsconditions.edit',compact('data'));
    }
